...
function PANEL:Setup()
        ...
        if self.ListRounded then
            self:Background(jlib.Colors.Primary, self.ListRoundedSize)
        else
            self:Background(jlib.Colors.Primary, 0)
        end

        if self.ShowListOutline then
            self:Outline(jlib.Colors.White, self.ListOutlineRadius)
        end
    ...
    for k,v in pairs(self.Items) do
        if v.Type == "checkbox" then
            ...
            container:ClearPaint()
                :Background(jlib.Colors.Secondary, 5)
            ...
            title:SetFont("jlib.font.button")
            ...
            checkbox:TDLib()
            checkbox:ClearPaint()
                :CircleCheckbox(jlib.Colors.Green)
        ...
        elseif v.Type == "slider" then
            ...
            slider:TDLib()
            slider:ClearPaint()
                :Background(jlib.Colors.Primary, 5)
        elseif v.Type == "button" then
            ...
            local button = container:Add("jlib_button")
            ...
            button:SetFont("jlib.font.button")
        elseif v.Type == "entry" then
            ...
            local entry = container:Add("jlib_entry")
            entry:Dock(RIGHT)
            ...
            entry:SetFont("jlib.font.button")
        end     
    end
end
...
vgui.Register("jlib_list", PANEL, "DScrollPanel")